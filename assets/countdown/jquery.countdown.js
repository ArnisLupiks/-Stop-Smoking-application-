...
//init and switchdigit helper functions
function init(elem, options){
    ...
    $.each(['Days','Hours','Minutes','Seconds'],function(i){
        ...
        if(this!="Seconds"){
           ...
           $(".countDays").append('<label>d</label>')
		   $(".countHours").append('<label>h</label>')
           $(".countMinutes").append('<label>m</label>')
           $(".countSeconds").append('<label>s</label>')
}
